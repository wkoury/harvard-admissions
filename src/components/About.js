...
const About = () => {
    return(
        <div className='about'>
            ...
            <p>The underlying research behind this site was done by Drs. Tyler Ransom, Josh Kinsler, and Peter Arcidiacono. Web development was done by William Koury.</p>
